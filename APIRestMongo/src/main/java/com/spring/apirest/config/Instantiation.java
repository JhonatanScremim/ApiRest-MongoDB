...
import com.spring.apirest.dto.AuthorDTO;
import com.spring.apirest.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("21/08/2019"), "Bom dia", "Acordei feliz hoje !", new AuthorDTO(maria));
